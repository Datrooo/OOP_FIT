...
The parameter $\ast${\ttfamily matchers...}$\ast$ is a comma-\/separated list of \href{../gmock_for_dummies.md\#matchers-what-arguments-do-we-expect}{\texttt{ matchers}} that correspond to each argument of the method $\ast${\ttfamily method\+\_\+name}$\ast$. The expectation will apply only to calls of $\ast${\ttfamily method\+\_\+name}$\ast$ whose arguments match all of the matchers. If {\ttfamily (}$\ast${\ttfamily matchers...}$\ast${\ttfamily )} is omitted, the expectation behaves as if each argument\textquotesingle{}s matcher were a \href{matchers.md\#wildcard}{\texttt{ wildcard matcher ({\ttfamily \+\_\+})}}. See the /home/drakowkq/work/labs/lab1(bit\+Arr)/googletest/docs/reference/matchers.md \char`\"{}\+Matchers Reference\char`\"{} for a list of all built-\/in matchers.
...
The parameter $\ast${\ttfamily action}$\ast$ represents the \href{../gmock_for_dummies.md\#actions-what-should-it-do}{\texttt{ action}} that the function call will perform. See the /home/drakowkq/work/labs/lab1(bit\+Arr)/googletest/docs/reference/actions.md \char`\"{}\+Actions Reference\char`\"{} for a list of built-\/in actions.
...
The parameter $\ast${\ttfamily matchers...}$\ast$ is a comma-\/separated list of \href{../gmock_for_dummies.md\#matchers-what-arguments-do-we-expect}{\texttt{ matchers}} that correspond to each argument of the method $\ast${\ttfamily method\+\_\+name}$\ast$. The {\ttfamily ON\+\_\+\+CALL} specification will apply only to calls of $\ast${\ttfamily method\+\_\+name}$\ast$ whose arguments match all of the matchers. If {\ttfamily (}$\ast${\ttfamily matchers...}$\ast${\ttfamily )} is omitted, the behavior is as if each argument\textquotesingle{}s matcher were a \href{matchers.md\#wildcard}{\texttt{ wildcard matcher ({\ttfamily \+\_\+})}}. See the /home/drakowkq/work/labs/lab1(bit\+Arr)/googletest/docs/reference/matchers.md \char`\"{}\+Matchers Reference\char`\"{} for a list of all built-\/in matchers.
