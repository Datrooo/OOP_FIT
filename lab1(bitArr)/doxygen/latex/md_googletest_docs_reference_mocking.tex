...
The parameter $\ast${\ttfamily matchers...}$\ast$ is a comma-\/separated list of \href{../gmock_for_dummies.md\#matchers-what-arguments-do-we-expect}{\texttt{ matchers}} that correspond to each argument of the method $\ast${\ttfamily method\+\_\+name}$\ast$. The expectation will apply only to calls of $\ast${\ttfamily method\+\_\+name}$\ast$ whose arguments match all of the matchers. If {\ttfamily (}$\ast${\ttfamily matchers...}$\ast${\ttfamily )} is omitted, the expectation behaves as if each argument\textquotesingle{}s matcher were a \href{matchers.md\#wildcard}{\texttt{ wildcard matcher ({\ttfamily \+\_\+})}}. See the /home/drakowkq/work/\+OOP\+\_\+\+FIT/lab1(bit\+Arr)/googletest/docs/reference/matchers.md \char`\"{}\+Matchers Reference\char`\"{} for a list of all built-\/in matchers.
...
See details for each modifier clause below.\hypertarget{md_googletest_docs_reference_mocking_autotoc_md263}{}\doxysubsubsection{With \{\#\+EXPECT\+\_\+\+CALL.\+With\}}\label{md_googletest_docs_reference_mocking_autotoc_md263}
...
The {\ttfamily With} clause can be used at most once on an expectation and must be the first clause.\hypertarget{md_googletest_docs_reference_mocking_autotoc_md264}{}\doxysubsubsection{Times \{\#\+EXPECT\+\_\+\+CALL.\+Times\}}\label{md_googletest_docs_reference_mocking_autotoc_md264}
...
The {\ttfamily Times} clause can be used at most once on an expectation.\hypertarget{md_googletest_docs_reference_mocking_autotoc_md265}{}\doxysubsubsection{In\+Sequence \{\#\+EXPECT\+\_\+\+CALL.\+In\+Sequence\}}\label{md_googletest_docs_reference_mocking_autotoc_md265}
...
See also the \href{\#InSequence}{\texttt{ {\ttfamily In\+Sequence} class}}.\hypertarget{md_googletest_docs_reference_mocking_autotoc_md266}{}\doxysubsubsection{After \{\#\+EXPECT\+\_\+\+CALL.\+After\}}\label{md_googletest_docs_reference_mocking_autotoc_md266}
...
The {\ttfamily After} clause can be used any number of times on an expectation.\hypertarget{md_googletest_docs_reference_mocking_autotoc_md267}{}\doxysubsubsection{Will\+Once \{\#\+EXPECT\+\_\+\+CALL.\+Will\+Once\}}\label{md_googletest_docs_reference_mocking_autotoc_md267}
...
The parameter $\ast${\ttfamily action}$\ast$ represents the \href{../gmock_for_dummies.md\#actions-what-should-it-do}{\texttt{ action}} that the function call will perform. See the /home/drakowkq/work/\+OOP\+\_\+\+FIT/lab1(bit\+Arr)/googletest/docs/reference/actions.md \char`\"{}\+Actions Reference\char`\"{} for a list of built-\/in actions.
...
The {\ttfamily Will\+Once} clause can be used any number of times on an expectation. Unlike {\ttfamily Will\+Repeatedly}, the action fed to each {\ttfamily Will\+Once} call will be called at most once, so may be a move-\/only type and/or have an {\ttfamily \&\&}-\/qualified call operator.\hypertarget{md_googletest_docs_reference_mocking_autotoc_md268}{}\doxysubsubsection{Will\+Repeatedly \{\#\+EXPECT\+\_\+\+CALL.\+Will\+Repeatedly\}}\label{md_googletest_docs_reference_mocking_autotoc_md268}
...
The {\ttfamily Will\+Repeatedly} clause can be used at most once on an expectation.\hypertarget{md_googletest_docs_reference_mocking_autotoc_md269}{}\doxysubsubsection{Retires\+On\+Saturation \{\#\+EXPECT\+\_\+\+CALL.\+Retires\+On\+Saturation\}}\label{md_googletest_docs_reference_mocking_autotoc_md269}
...
The parameter $\ast${\ttfamily matchers...}$\ast$ is a comma-\/separated list of \href{../gmock_for_dummies.md\#matchers-what-arguments-do-we-expect}{\texttt{ matchers}} that correspond to each argument of the method $\ast${\ttfamily method\+\_\+name}$\ast$. The {\ttfamily ON\+\_\+\+CALL} specification will apply only to calls of $\ast${\ttfamily method\+\_\+name}$\ast$ whose arguments match all of the matchers. If {\ttfamily (}$\ast${\ttfamily matchers...}$\ast${\ttfamily )} is omitted, the behavior is as if each argument\textquotesingle{}s matcher were a \href{matchers.md\#wildcard}{\texttt{ wildcard matcher ({\ttfamily \+\_\+})}}. See the /home/drakowkq/work/\+OOP\+\_\+\+FIT/lab1(bit\+Arr)/googletest/docs/reference/matchers.md \char`\"{}\+Matchers Reference\char`\"{} for a list of all built-\/in matchers.
...
See details for each modifier clause below.\hypertarget{md_googletest_docs_reference_mocking_autotoc_md270}{}\doxysubsubsection{With \{\#\+ON\+\_\+\+CALL.\+With\}}\label{md_googletest_docs_reference_mocking_autotoc_md270}
{\ttfamily .With(}$\ast${\ttfamily multi\+\_\+argument\+\_\+matcher}$\ast${\ttfamily )}
...
The {\ttfamily With} clause can be used at most once with each {\ttfamily ON\+\_\+\+CALL} statement.\hypertarget{md_googletest_docs_reference_mocking_autotoc_md271}{}\doxysubsubsection{Will\+By\+Default \{\#\+ON\+\_\+\+CALL.\+Will\+By\+Default\}}\label{md_googletest_docs_reference_mocking_autotoc_md271}
