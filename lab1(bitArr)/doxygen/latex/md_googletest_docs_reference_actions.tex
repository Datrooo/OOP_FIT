...
\end{longtabu}
\hypertarget{md_googletest_docs_reference_actions_autotoc_md245}{}\doxysection{Side Effects}\label{md_googletest_docs_reference_actions_autotoc_md245}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_docs_reference_actions_autotoc_md246}{}\doxysection{Using a Function, Functor, or Lambda as an Action}\label{md_googletest_docs_reference_actions_autotoc_md246}
...
calls the mock function\textquotesingle{}s \#2 argument, passing to it {\ttfamily 5} and {\ttfamily string(\char`\"{}\+Hi\char`\"{})} by value, and {\ttfamily foo} by reference.\hypertarget{md_googletest_docs_reference_actions_autotoc_md247}{}\doxysection{Default Action}\label{md_googletest_docs_reference_actions_autotoc_md247}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\{\+: .callout .note\} {\bfseries{Note\+:}} due to technical reasons, {\ttfamily Do\+Default()} cannot be used inside a composite action -\/ trying to do so will result in a run-\/time error.\hypertarget{md_googletest_docs_reference_actions_autotoc_md248}{}\doxysection{Composite Actions}\label{md_googletest_docs_reference_actions_autotoc_md248}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
\cellcolor{\tableheadbgcolor}\textbf{ Action   }&\cellcolor{\tableheadbgcolor}\textbf{ Description    }\\\cline{1-2}
...
\end{longtabu}
\hypertarget{md_googletest_docs_reference_actions_autotoc_md249}{}\doxysection{Defining Actions}\label{md_googletest_docs_reference_actions_autotoc_md249}
\tabulinesep=1mm
\begin{longtabu}spread 0pt [c]{*{2}{|X[-1]}|}
\hline
