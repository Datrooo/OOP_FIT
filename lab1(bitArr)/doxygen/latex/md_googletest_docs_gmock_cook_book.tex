You can find recipes for using g\+Mock here. If you haven\textquotesingle{}t yet, please read /home/drakowkq/work/\+OOP\+\_\+\+FIT/lab1(bit\+Arr)/googletest/docs/gmock\+\_\+for\+\_\+dummies.md \char`\"{}the dummy guide\char`\"{} first to make sure you understand the basics.
...
g\+Mock provides a set of built-\/in matchers for matching arguments with expected values—see the /home/drakowkq/work/\+OOP\+\_\+\+FIT/lab1(bit\+Arr)/googletest/docs/reference/matchers.md \char`\"{}\+Matchers Reference\char`\"{} for more information. In case you find the built-\/in set lacking, you can use an arbitrary unary predicate function or functor as a matcher -\/ as long as the predicate accepts a value of the type you want. You do this by wrapping the predicate inside the {\ttfamily Truly()} function, for example\+:
...
Note that the predicate function / functor doesn\textquotesingle{}t have to return {\ttfamily bool}. It works as long as the return value can be used as the condition in in statement {\ttfamily if (condition) ...}.\hypertarget{md_googletest_docs_gmock_cook_book_autotoc_md137}{}\doxysubsection{Matching Arguments that Are Not Copyable}\label{md_googletest_docs_gmock_cook_book_autotoc_md137}
...
\end{DoxyCode}
\hypertarget{md_googletest_docs_gmock_cook_book_SaveArgVerify}{}\doxysubsection{Verifying Complex Arguments}\label{md_googletest_docs_gmock_cook_book_SaveArgVerify}
