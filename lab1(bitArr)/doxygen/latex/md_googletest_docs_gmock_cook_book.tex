You can find recipes for using g\+Mock here. If you haven\textquotesingle{}t yet, please read /home/drakowkq/work/labs/lab1(bit\+Arr)/googletest/docs/gmock\+\_\+for\+\_\+dummies.md \char`\"{}the dummy guide\char`\"{} first to make sure you understand the basics.
...
g\+Mock provides a set of built-\/in matchers for matching arguments with expected values—see the /home/drakowkq/work/labs/lab1(bit\+Arr)/googletest/docs/reference/matchers.md \char`\"{}\+Matchers Reference\char`\"{} for more information. In case you find the built-\/in set lacking, you can use an arbitrary unary predicate function or functor as a matcher -\/ as long as the predicate accepts a value of the type you want. You do this by wrapping the predicate inside the {\ttfamily Truly()} function, for example\+:
