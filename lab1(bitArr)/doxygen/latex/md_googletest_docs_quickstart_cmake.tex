This tutorial aims to get you up and running with Google\+Test using CMake. If you\textquotesingle{}re using Google\+Test for the first time or need a refresher, we recommend this tutorial as a starting point. If your project uses Bazel, see the /home/drakowkq/work/labs/lab1(bit\+Arr)/googletest/docs/quickstart-\/bazel.md \char`\"{}\+Quickstart for Bazel\char`\"{} instead.\hypertarget{md_googletest_docs_quickstart_cmake_autotoc_md239}{}\doxysection{Prerequisites}\label{md_googletest_docs_quickstart_cmake_autotoc_md239}
...
See /home/drakowkq/work/labs/lab1(bit\+Arr)/googletest/docs/platforms.md \char`\"{}\+Supported Platforms\char`\"{} for more information about platforms compatible with Google\+Test.
...
\begin{DoxyItemize}
\item /home/drakowkq/work/labs/lab1(bit\+Arr)/googletest/docs/primer.md \char`\"{}\+Check out the Primer\char`\"{} to start learning how to write simple tests.
\item /home/drakowkq/work/labs/lab1(bit\+Arr)/googletest/docs/samples.md \char`\"{}\+See the code samples\char`\"{} for more examples showing how to use a variety of Google\+Test features. 
\end{DoxyItemize}