This tutorial aims to get you up and running with Google\+Test using CMake. If you\textquotesingle{}re using Google\+Test for the first time or need a refresher, we recommend this tutorial as a starting point. If your project uses Bazel, see the /home/drakowkq/work/\+OOP\+\_\+\+FIT/lab1(bit\+Arr)/googletest/docs/quickstart-\/bazel.md \char`\"{}\+Quickstart for Bazel\char`\"{} instead.\hypertarget{md_googletest_docs_quickstart_cmake_autotoc_md239}{}\doxysection{Prerequisites}\label{md_googletest_docs_quickstart_cmake_autotoc_md239}
...
See /home/drakowkq/work/\+OOP\+\_\+\+FIT/lab1(bit\+Arr)/googletest/docs/platforms.md \char`\"{}\+Supported Platforms\char`\"{} for more information about platforms compatible with Google\+Test.
...
\{\+: .callout .note\} Note\+: The terminal commands in this tutorial show a Unix shell prompt, but the commands work on the Windows command line as well.\hypertarget{md_googletest_docs_quickstart_cmake_autotoc_md240}{}\doxysection{Set up a project}\label{md_googletest_docs_quickstart_cmake_autotoc_md240}
...
For more information about how to create {\ttfamily CMake\+Lists.\+txt} files, see the \href{https://cmake.org/cmake/help/latest/guide/tutorial/index.html}{\texttt{ CMake Tutorial}}.\hypertarget{md_googletest_docs_quickstart_cmake_autotoc_md241}{}\doxysection{Create and run a binary}\label{md_googletest_docs_quickstart_cmake_autotoc_md241}
...
Congratulations! You\textquotesingle{}ve successfully built and run a test binary using Google\+Test.\hypertarget{md_googletest_docs_quickstart_cmake_autotoc_md242}{}\doxysection{Next steps}\label{md_googletest_docs_quickstart_cmake_autotoc_md242}

\begin{DoxyItemize}
\item /home/drakowkq/work/\+OOP\+\_\+\+FIT/lab1(bit\+Arr)/googletest/docs/primer.md \char`\"{}\+Check out the Primer\char`\"{} to start learning how to write simple tests.
\item /home/drakowkq/work/\+OOP\+\_\+\+FIT/lab1(bit\+Arr)/googletest/docs/samples.md \char`\"{}\+See the code samples\char`\"{} for more examples showing how to use a variety of Google\+Test features. 
\end{DoxyItemize}