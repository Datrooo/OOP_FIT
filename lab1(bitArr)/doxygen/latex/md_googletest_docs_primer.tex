\hypertarget{md_googletest_docs_primer_autotoc_md225}{}\doxysection{Introduction\+: Why googletest?}\label{md_googletest_docs_primer_autotoc_md225}
...
\end{longtabu}
\hypertarget{md_googletest_docs_primer_autotoc_md227}{}\doxysection{Basic Concepts}\label{md_googletest_docs_primer_autotoc_md227}
...
We\textquotesingle{}ll now explain how to write a test program, starting at the individual assertion level and building up to tests and test suites.\hypertarget{md_googletest_docs_primer_autotoc_md228}{}\doxysection{Assertions}\label{md_googletest_docs_primer_autotoc_md228}
...
Google\+Test provides a collection of assertions for verifying the behavior of your code in various ways. You can check Boolean conditions, compare values based on relational operators, verify string values, floating-\/point values, and much more. There are even assertions that enable you to verify more complex states by providing custom predicates. For the complete list of assertions provided by Google\+Test, see the /home/drakowkq/work/\+OOP\+\_\+\+FIT/lab1(bit\+Arr)/googletest/docs/reference/assertions.md \char`\"{}\+Assertions Reference\char`\"{}.\hypertarget{md_googletest_docs_primer_autotoc_md229}{}\doxysection{Simple Tests}\label{md_googletest_docs_primer_autotoc_md229}
To create a test\+:
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs_primer_autotoc_md230}{}\doxysection{Invoking the Tests}\label{md_googletest_docs_primer_autotoc_md230}
...
{\bfseries{Availability}}\+: Linux, Windows, Mac.\hypertarget{md_googletest_docs_primer_autotoc_md231}{}\doxysection{Writing the main() Function}\label{md_googletest_docs_primer_autotoc_md231}
...
The {\ttfamily \+::testing\+::\+Init\+Google\+Test()} function parses the command line for googletest flags, and removes all recognized flags. This allows the user to control a test program\textquotesingle{}s behavior via various flags, which we\textquotesingle{}ll cover in the /home/drakowkq/work/\+OOP\+\_\+\+FIT/lab1(bit\+Arr)/googletest/docs/advanced.md \char`\"{}\+Advanced\+Guide\char`\"{}. You {\bfseries{must}} call this function before calling {\ttfamily RUN\+\_\+\+ALL\+\_\+\+TESTS()}, or the flags won\textquotesingle{}t be properly initialized.
...
\{\+: .callout .note\} NOTE\+: {\ttfamily Parse\+GUnit\+Flags()} is deprecated in favor of {\ttfamily Init\+Google\+Test()}.\hypertarget{md_googletest_docs_primer_autotoc_md232}{}\doxysection{Known Limitations}\label{md_googletest_docs_primer_autotoc_md232}
